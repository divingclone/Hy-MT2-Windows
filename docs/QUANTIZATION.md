...
当前默认 NVFP4 模型使用 OPUS-100 中英翻译语料校准和局部加权 MSE 尺度搜索。默认 F16 KV；Q8_0 是同一程序的正式显存选项。模型来源、哈希与校准参数见 [provenance.json](../huggingface/provenance.json)，测量结果见 [性能报告](PERFORMANCE.md)。
